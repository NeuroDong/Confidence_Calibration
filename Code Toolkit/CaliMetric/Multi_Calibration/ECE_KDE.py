...
if __name__ == "__main__":
    ...
    ece_kde = get_ece_kde(f, y, p=1, mc_type='canonical', device=device)
    print("Estimated ECE (canonical):", ece_kde.item())

    ece_kde_marginal = get_ece_kde(f, y, p=1, mc_type='marginal', device=device)
    print("Estimated ECE (marginal):", ece_kde_marginal.item())

    ece_kde_toplabel = get_ece_kde(f, y, p=1, mc_type='top_label', device=device)
    print("Estimated ECE (top-label):", ece_kde_toplabel.item())